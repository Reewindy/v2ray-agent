...
``` 
wget -P/root -N --no-check-certificate "https://raw.githubusercontent.com/Reewindy/v2ray-agent/master/shell/install_en.sh" && mv /root/install_en.sh /root/install.sh && chmod 700 /root/install.sh &&/root/install.sh
``` 
